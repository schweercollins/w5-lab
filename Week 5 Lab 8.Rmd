...
knitr::kable(sum_d, 
             ...
             caption = "The greatest table of all time") # Add a caption so it shows up where it should
...
```{r plot, echo = FALSE, eval = TRUE, fig.cap = "Look how amazing!!! Can you even believe your eyes! It's beautiful!"}
# Add a figure caption using the above to get the figure to show up where it should
# Looks like you didn't need to do this... Not sure why
...
<!-- This all looks super great! Well done everybody! -->
